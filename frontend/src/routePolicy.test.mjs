...
assert.match(app, /<Route element={<RequireManager \/>}>[\s\S]*<Route path="\/employees" element={<EmployeesPage \/>} \/>[\s\S]*<\/Route>/)
assert.doesNotMatch(app, /<Route element={<RequireAuth \/>}>[\s\S]*<Route path="\/"/)
